...
Java_com_abbott_myyolov3_YOLOV3_Init(JNIEnv *env, jobject thiz, jbyteArray param,
                                            jbyteArray bin) {
    // TODO: implement Init()
    ncnn::Mat ncnn_param;
    ncnn::Mat ncnn_bin;
...
Java_com_abbott_myyolov3_YOLOV3_Detect(JNIEnv *env, jobject thiz, jobject bitmap) {
